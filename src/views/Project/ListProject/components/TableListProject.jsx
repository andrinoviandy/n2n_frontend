...
const TableListProject = ({ data, setData, tabActive, setSelectedData, sortBy, setNoKontrak, rangeDate }) => {
  const headerSA2Table = ["No", "No Project", "Nama Project", "Nama Sales", "Tipe Project", "Nama Customer", "Status Billing"];
  let headerTable;
  switch (tabActive?.kd_status) {
    case "001":
      headerTable = ["No", "No Project", "Nama Project", "Nama Sales", "Portofolio", "Tipe Project", "Estimasi Nilai Penarawan", "Estimasi COGS", "Nama Customer", "Area", "Category", "SLA", "Status Project"];
      break;
    case "002":
    case "003":
      headerTable = ["No", "No Project", "Nama Project", "Nama Sales", "Portofolio", "Tipe Project", "Nilai Penarawan", "COGS", "Nama Customer", "Area", "Category", "SLA", "Status Project"];
      break;
    case "004":
      headerTable = ["No", "No Project", "Nama Project", "Nama Sales", "Portofolio", "Tipe Project", "Nilai Kontrak", "Nomor Kontrak", "Nama Customer", "Area", "Category", "Akselerasi", "SLA", "Status Project"];
      break;
    case "101":
    case "102":
    case "103":
              ...
              return (
                <tr key={i}>
                  ...
                  {(tabActive?.kd_status !== "101" && tabActive?.kd_status !== "102" && tabActive?.kd_status !== "103") && (
                    <td className='min-w-14'>{v.SLA || '-'}</td>
                  )}
                  <td>{v.UR_STATUS || '-'}</td>
                </tr>
              )
