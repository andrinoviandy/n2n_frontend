    ...
    return (
        <div className='bg-white min-h-full w-[55%] flex flex-col'>
            <div className='items-center gap-5 flex flex-row p-5'>
                ...
                <div className='font-bold text-sm'>TOP Details</div>
            </div>
            ...
            <div className='overflow-auto'>
                ...
                <div className="m-4 flex flex-row rounded-[10px] bg-white border-2">
                    ...
                    <div className="divider divider-horizontal"></div>
                    <div className="flex-col p-3">
                        <div className="text-gray-400 text-xs">Total Expected Value</div>
                        <div className="text-xs font-bold">Rp 1.500.000.000</div>
                    </div>
                    <div className="divider divider-horizontal"></div>
                    <div className="flex-col p-3">
                        <div className="text-gray-400 text-xs">Total Termin</div>
                        <div className="text-xs font-bold">5 Termin</div>
                    </div>
                    <div className="divider divider-horizontal"></div>
                    <div className="flex-col p-3">
                ...
                <div className='m-4 gap-4 flex flex-row'>
                    <div className='rounded-[15px] border-2 border-gray-200 justify-center px-2 py-1 font-bold'>Deliverables</div>
                    <div className='rounded-[15px] border-2 border-gray-200 justify-center px-2 py-1 font-bold'>Settlement</div>
                </div>
