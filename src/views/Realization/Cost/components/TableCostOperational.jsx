...
const TableCostOperational = ({ data, setData, setSelectedData, sortBy, startDate, endDate }) => {
  const headerTable = ["No", "No Project", "Nama Project", "Divisi", "Total Tagihan"];
...
export default TableCostOperational