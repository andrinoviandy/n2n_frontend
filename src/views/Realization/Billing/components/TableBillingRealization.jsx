...
const TableBillingRealization = ({ data, setData, setSelectedData, sortBy, rangeDate }) => {
  const headerTable = ["No", "No Project", "Nama Project", "Portfolio", "Tipe Project", "Nomor Kontrak", "Nilai Kontrak"];
...
export default TableBillingRealization