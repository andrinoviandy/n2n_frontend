  ...
  return (
    <>
      ...
      <div ref={loginRef} className='flex md:items-center md:justify-center center w-screen h-screen bg-base-100' style={backgroundStyle}>
        <div className="md:card w-full shadow-all bg-base-100" style={{ width: width < 768 ? width : '550px' }}>
          <div className="card-body">
            <div className="card-title justify-center">
              <POTTER_LOGO className="card-title justify-center" />
            </div>
            <form onSubmit={handleLogin}>
              <div className='flex flex-col p-5 gap-2'>
                ...
                <label className="form-control">
                  ...
                  <input name="user_password" type={showPassword ? "text" : "password"} placeholder="Password" className="input input-bordered rounded-[25px] px-3 py-2 text-base" onChange={handleChange} />
                  <div
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute w-max right-6 eye-position"
                  >
                    {showPassword ? (
                      <img
                        width={24}
