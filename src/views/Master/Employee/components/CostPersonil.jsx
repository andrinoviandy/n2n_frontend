...
const CostPersonil = ({ location, data, getDetailProject, isDetailModalAkselerasi, isVendorRealization, isBillingRealization }) => {
  ...
  const headerTable = ['Start Periode', 'End Periode', 'Estimasi Cost', 'Realisasi Cost', '']
  ...
  return (
    <>
      <div className='card border-2 my-5'>
        <div className='absolute left-10 -top-3 px-2 bg-white text-sm font-semibold'>Cost Personil</div>
        <div className='card-body'>
          ...
          <div type="button" className='btn btn-sm ml-3 rounded-[25px] border-none bg-blue-50 text-primary mt-3 w-60 ' onClick={handleAddField}>
            <RxPlusCircled size='20px' /> Add Cost Personil
          </div>
          {/* )} */}
        </div >
      </div >
