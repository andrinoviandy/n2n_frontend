...
const TableEmployee = ({ data, setData, setSelectedData, sortBy }) => {
  const headerTable = ["No", "NIK", "Nama", "Role", "Divisi", "Department", "Kontrak", "Start Date", "End Date", "Lama Kerja", "Status"];
