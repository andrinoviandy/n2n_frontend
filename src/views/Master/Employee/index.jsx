...
const Employee = () => {
  ...
  const handleAdd = async (e) => {
    e.preventDefault();
    navigation('/add-employee-master', {
      state: {
        ...location.state,
      ...
      >
        <div className='flex flex-row mb-4'>
          <div className='flex flex-row'>
            <ProjectID />
            <div className='ml-2'>
              <p className='text-xs font-bold'>No Project</p>
      ...
      <div className='bg-white px-6 pt-10 h-full'>
        <div className='flex sm:flex-row flex-col gap-5 '>
          <div className='sm:w-full'>
            <p className='text-lg font-bold'>Master Employee</p>
            <p className='text-base font-light'>View your list master employee in here.</p>
          </div>
